...
int getFullurlByFileid(char *fileid, char *fdfs_file_url)
{
    ...
    else //父进程
    {
        ...
        wait(NULL); //等待子进程结束，回收其资源
        close(fd[0]);
        cout << "fdfs_file_stat_buf: " << fdfs_file_stat_buf;
        ...
        cout << "host_name:" << s_storage_web_server_ip;
        ...
        cout << "fdfs_file_url:" << fdfs_file_url;
    }
...
{
    ApiUploadInit("/etc/fdfs/client.conf","119.23.41.13","8081","119.23.41.13","23000");
    UNUSED(url);
    ...
    cout << "file_content_type: " << file_content_type<<endl;
    ...
    cout << "uploadFileToFastDfs, file_name:" << file_name << ", new_file_path:" << new_file_path<<endl;
    ...
    // 拼接出完整的http地址
    cout << "getFullurlByFileid, fileid: " << fileid<<endl;
    ...
    cout << "storeFileinfo, url: " << fdfs_file_url<<endl;
    // 把文件写入file_info
    ...
    //================> 删除本地临时存放的上传文件 <===============
    cout << "unlink: " << new_file_path<<endl;
